...
def main():
    try:
        ...
        coin_base_amount = coin_base.amount() + float(_CONFIG['COINBASE']['INVERSION'])

        google_api.save(coin_base_amount, _CONFIG['GOOGLE']['SHEET'], _CONFIG['COINBASE']['RANGE'])
        google_api.save(coin_base_pro_amount, _CONFIG['GOOGLE']['SHEET'], _CONFIG['COINBASE_PRO']['RANGE'])
